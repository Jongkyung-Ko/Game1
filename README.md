...
주인공은 게임 시작 시 **기사 / 용사 / 마법사 / 궁수** 중 직업을 고른 뒤 **자기 집 안에서** 출발하며, `마을로 나가기`를 눌러 마을로 나옵니다. 레벨 5·10·15에 상위 직군으로 전직하고, 레벨 20에 각성합니다. 전직할 때마다 레벨업 능력 상승이 이전의 3배가 됩니다.
...
바로 설치할 파일: [MedievalVillage-v0.4.45-debug.apk](https://github.com/Jongkyung-Ko/Game1/releases/download/v0.4.45/MedievalVillage-v0.4.45-debug.apk)

이전 버전은 [Releases](https://github.com/Jongkyung-Ko/Game1/releases) 에서 받을 수 있습니다.

1. 위 APK 를 폰으로 다운로드
2. 폰 **설정 > 보안** 에서 알 수 없는 앱 설치 허용
3. APK 를 열어 설치 → 앱 이름 **중세마을 v0.4.45**
